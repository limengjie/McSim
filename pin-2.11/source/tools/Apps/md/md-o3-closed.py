...
pts.num_hthreads             = 16 # max num of hw threads supported
pts.num_hthreads_per_l1$     = 1 # num of threads per l1$ (and core)
pts.num_l1$_per_l2$          = 4 # num of l1$ sharing an l2$
pts.num_mcs                  = 4 # this is no use, always one MC per l2$
...
pts.l1d$.to_lsu_t           = 4 
pts.l1d$.to_l2_t            = 60 # orig 40
pts.l1d$.num_sets_per_subarray = 8
pts.l1d$.always_hit         = false

pts.l2$.num_sets            = 8192
pts.l2$.num_ways            = 16
pts.l2$.set_lsb             = 6
pts.l2$.process_interval    = 12
pts.l2$.to_l1_t             = 60 # orig 40
pts.l2$.to_dir_t            = 40
pts.l2$.to_xbar_t           = 40
pts.l2$.num_banks           = 4
...
pts.rbol.do_not_check_neighbors  = false
pts.rbol.adaptive_rbol_line      = true
pts.rbol.set_lsb                 = 8   # RBoL evict granularity
pts.rbol.rbol_set_lsb            = 14
pts.rbol.pred_set_lsb            = 14
pts.rbol.rbol_entry_lsb          = 8  # predictor & RBoL fetch granularity
pts.rbol.num_rbol_sets           = 8
pts.rbol.num_rbol_ways           = 32
pts.rbol.num_pred_sets           = 16
pts.rbol.num_pred_ways           = 16
pts.rbol.process_interval        = 30
pts.rbol.to_dir_hit_t            = 60  # how many ticks it needs to send a L2 cache line
pts.rbol.max_prefetch_rbol_lines = 8
...
pts.mc.process_interval      = 36 #orig 30
pts.mc.to_dir_t              = 430
...
pts.mc.refresh_interval  = 8000000000000000
